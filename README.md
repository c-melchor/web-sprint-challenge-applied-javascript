...
1. What is the DOM?
defines the logical structure of HTML

2. What is an event?
Anything that happens on a page: click, scroll, mouse over, mouse leave, key up, etc

3. What is an event listener?
a function that listens to whatever event is passed into it, and executes whatever code is written in the return portion of the function. It accepts an event to listen to and then has a callback function that returns whatever you tell it to.

4. Why would we convert a NodeList into an Array?
in order to use array methods such as .map(), .filter(), .reduce(), etc

5. What is a component?
a valid HTML element that allows you to give a website structure and data in addition to the DOM
